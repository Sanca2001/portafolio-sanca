...
const timelineData: TimelineItemData[] = [
    ...
    {
        id: "timeline-item-1",
        title: " Desarrollador Informático - Tecsis Ingenieria S.A ",
        type: "Full-time",
        duration: "ENERO 2026 - ABRIL 2026",
        icon: Code,
        responsibilities: [
    ...
    {
        id: "timeline-item-2",
        title: "Inspector de Packing - Empacadora Sello Verde",
        type: "Full-time",
...

    {
        ...
        responsibilities: [
            ...
            "Registré, clasifiqué, documenté y realicé seguimiento a incidencias y solicitudes de soporte.",
            "Brindé formación y apoyo a los usuarios sobre el uso de software y herramientas tecnológicas.",
            "Ayudé a mantener el inventario de equipos actualizado.",
    ...
    {
        id: "timeline-item-4",
        title: "Diseñador UX/UI - Agencia Online JF",
        type: "Full-time",
        duration: "ENERO 2024 - MAYO 2024",
        icon: Palette,
        responsibilities: [
    ...
    {
        id: "timeline-item-5",
        title: "Practicante Pre - Profesional - Municipalidad Distrital de Pacanga",
        type: "Full-time",
...
export default function TimelinePage() {
    return (
        <div className="dark:bg-black min-h-screen p-4 sm:p-8 transition-colors duration-300">
            <div className="max-w-3xl mx-auto">
                <header className="flex justify-between items-center mb-8">
                    <h1 className="text-3xl font-bold text-slate-800 dark:text-slate-100"> Experiencia Profesional </h1>
                </header>
